...
import Labeltext from './LabelTextfieldsTeacher';
    ...
    >
      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding" enabled>
        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
          <View style={{
            backgroundColor: colors.light_bg, borderTopLeftRadius: 30, shadowColor: 'black', // Shadow color
            ...
            elevation: 5, alignItems: 'center', borderTopRightRadius: 30, marginLeft: 5, marginRight: 8, height: 610
          }}>
            ...
            <View style={styles.labelContainer}>
              ...
              <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                <Button mode="contained" style={styles.savebtn} onPress={() => console.log('Pressed')}>
                  Apply Changes
                </Button>
              </View>
            </View>
